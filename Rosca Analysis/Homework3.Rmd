...
text <- data.frame(
  ...
  x_pos = c(0.8,1.2,1.8,2.2,2.8,3.2),
  y_pos = c(32, 78, 53, 140, 25, 88),
  label = str_c(prop, "%")
)
...
temp_text <- data.frame(
  # this is important (help the label to find where it belongs 1 -> mean 34, 2 -> mean 32)
...
graph <- ggplot(data = weather, aes(x = temp )) +
