...
ggplot(data = G1, mapping = aes(x = flipper_length_mm /10, y = average, group = sex)) +
  # make line for each sex
  # separate each spcices
...
I found that Gentoo overall has a very high potential of having more bill length as fliper length length increases as I observe from the graph.
